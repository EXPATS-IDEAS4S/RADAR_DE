...
from readers.s3_buckets_credentials import S3_BUCKET_TIMESERIES_NAME, S3_ACCESS_KEY, S3_SECRET_ACCESS_KEY, S3_ENDPOINT_URL
from RADAR_DE.readers.data_buckets_funcs import Initialize_s3_client, upload_file
